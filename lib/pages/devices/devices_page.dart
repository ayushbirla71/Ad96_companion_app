...
class _DevicesPageState extends State<DevicesPage> {
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 8,
                    children: ['all', 'online', 'offline', 'active'].map((s) {
                      final isSelected = deviceProvider.statusFilter == s;
                      return GestureDetector(
                        onTap: () => setModalState(
                          () => deviceProvider.setStatusFilter(s),
                        ),
                        child: Container(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //             colors: [appColors.green, const Color(0xFF047857)],
      ...
      //           ),
      //           Text(
      //             '${deviceProvider.filteredDevices.length} device${deviceProvider.filteredDevices.length != 1 ? 's' : ''}',
      //             style: TextStyle(
      //               color: appColors.textMuted,
      //               fontSize: 10,
      //               height: 1,
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      onChanged: (v) {
                        ...
                        Future.microtask(() => deviceProvider.setSearch(v));
                      },
                    ),
                  ),
                ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:
                          (deviceProvider.statusFilter != 'all' ||
                              deviceProvider.groupFilter != 'all')
...
class _DeviceCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final sc = _statusColor(device.status ?? '');
    final sb = _statusBg(device.status ?? '');
